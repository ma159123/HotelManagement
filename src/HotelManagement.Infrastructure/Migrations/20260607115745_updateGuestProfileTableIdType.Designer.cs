...
namespace HotelManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260607115745_updateGuestProfileTableIdType")]
    partial class updateGuestProfileTableIdType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HotelManagement.Domain.Entities.GuestProfile", b =>
                {
                    b.HasOne("HotelManagement.Domain.Entities.Guest", "Guest")
                        .WithOne("Profile")
                        .HasForeignKey("HotelManagement.Domain.Entities.GuestProfile", "GuestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
